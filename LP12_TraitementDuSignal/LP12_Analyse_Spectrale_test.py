# -*- coding: utf-8 -*-
"""
Created on Wed Apr 26 19:22:52 2023
...
s_full=np.loadtxt(open("diapason_deux_5000.csv"), delimiter=",", skiprows=2)
#
...
freq_ech0=1/(data_full[1,0]-data_full[0,0]) # f = 1/dt
...
#    plt.text(0.6, 0.2, "Fréquence d'échantillonnage", transform=ax0.transAxes)
    ...
    ax11 = ax1.twinx()
    ax11.plot(freq_full[0:n_split_ech],np.abs(spectre_full[0:n_split_ech]), "g-", linewidth=1)
